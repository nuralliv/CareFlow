  ...
  return (
    ...
    <section className="specialty-page">
      <div className="specialty-header">
        <h1>
          <span className="emoji"><Image width={60} src={therapySpecialty.emoji}/></span>{" "}
          {therapySpecialty.title}
        </h1>
        <div className="subtitle">{therapySpecialty.subtitle}</div>
        <p className="description">{therapySpecialty.description}</p>

...
export default function DoctorWorkDaysPage() {
    return (
        <section className="container">
            <main className="left">
                ...
                <div className="options-spe">
                    <Options label="Понедельник" className="" />
                    <Options label="Вторник" className="" />
                    <Options label="Среда" className="" />
                    <Options label="Четверг" className="" />
                    <Options label="Пятница" className="" />
                    <Options label="Суббота" className="" />
                    <Options label="Воскресенье" className="" />
                </div>

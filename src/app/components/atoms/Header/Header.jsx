...
import "./header.css";
import BurgerMenu from "@/app/images/burIcon.svg"
import xIcon from "@/app/images/iconX.svg"
    ...
    return (
        <header className="header">
            ...
            <nav className="nav">
                <div
                    className="nav-item"
                    onClick={() => handleNavigate("/pages/main")}
                >
                    Главная
                </div>
                ...
                <div
                    className="nav-item"
                    onClick={() =>
                        router.push("/pages/Appointment/Notifications")
                    }
                >
                    Уведомления
                </div>
            ...
            <div className="burgerMenu" onClick={toggleBurgerMenu}>
                <Image src={burgerOpen ? xIcon : BurgerMenu} alt="menu" height={20} width={20}/>
            </div>
        </header>
    );
}
